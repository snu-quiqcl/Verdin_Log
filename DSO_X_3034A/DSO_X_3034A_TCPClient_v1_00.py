...
class DSO_X_3034A(QtCore.QObject):

    def __init__(self, defaultIPAddress = '10.1.1.141', defaultTCPPort = 3034):
        super().__init__()  
    ...
    def readAllActiveData(self):
        ...
        self.xpoints[0~3] (list of integer): number of points in each channel
        
        self.yscale[0~3] (list of float): yscale of each channel. If the channel
        is off, it is 0.
        
        self.ydata[0~3] (list of integer array): ydata of each channel. If the
...
if __name__ == "__main__":    
    ...
    osc.write(':SINGle') # When DSO_X_3034A goes to Single, trigger mode is automatically reset to Normal
    time.sleep(0.5)
