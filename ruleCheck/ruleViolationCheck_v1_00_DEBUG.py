...
email_recipient = ['thkimatmit@gmail.com', ]
...
def main(argv):
    ...
    try:
        ...
        v18FaultList = list(v18.getFaultHistory())
        # If there is a flag file created from the previous error, remove it.
    ...
    try:
        chillerStatus = chiller.getChillerStatus()[0]
    ...
    if v18Status == 'OFF' and chillerStatus == '2':
...
#            daysSinceLastEmail = 2 # for debugging purpose. Remove later
    ...
    #########################################################################
    if v18Status == 'ON' and chillerStatus != '2':
        v18.turnOffLaser()
...
#    if chillerStatus == '2' and chillerTargetTemperature < minimumTargetTemp:
